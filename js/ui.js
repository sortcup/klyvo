...
import { initializeHeroCarousel } from './hero-carousel.js';
...
function renderFooter() {
  ...
  target.innerHTML = `
    <div class="container py-5">
      <div class="row g-4">
        <div class="col-lg-5"><a class="brand-lockup footer-brand" href="index.html"><img src="photo/logo.webp" alt="klyvo.tn" class="brand-icon" width="100" height="50"><br/></a><p class="mt-3 footer-intro">Des accessoires fiables pour votre téléphone, votre espace gaming, votre voiture et votre bureau.</p></div>
        ...
        <div class="col-lg-3"><h2 class="footer-title">Contact</h2><p><i class="bi bi-telephone me-2"></i>${escapeHtml(STORE_CONFIG.phone)}</p><p><i class="bi bi-envelope me-2"></i>${escapeHtml(STORE_CONFIG.email)}</p><p><i class="bi bi-geo-alt me-2"></i>${escapeHtml(STORE_CONFIG.address)}</p><div class="d-flex justify-content-center align-items-center gap-3 flex-nowrap"><a href="https://www.facebook.com/people/KLYVOTn/61594297703634/" class="link-primary link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover fw-semibold"><i class="bi bi-facebook"></i> </a><a href="https://wa.me/+21622592448" target="_blank" rel="noopener noreferrer" class="link-primary link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover fw-semibold"><i class="bi bi-whatsapp"></i> </a><a href="https://www.instagram.com/klyvo.tn?stkn=MTNuZ2l3MWhhOTk1Yg==" class="link-primary link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover fw-semibold"><i class="bi bi-instagram"></i> </a></div></div>
      </div>
    </div>
